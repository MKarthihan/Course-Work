...
class List:
    ...
    def _linear_search(self, key):
        ...
        neg = -1
        number = 0
        leng = len(self._values)
        while number < leng and neg == -1:
            if key == self._values[number]:
                neg = number
            number += 1
        return neg
    ...
    def union(self, source1, source2):
        ...
        while i < lst1:
            ...
            i += 1
        while x < lst2:
            if source2[x] not in self._values:
                self._values.append(source2[x])
            x += 1
        return
