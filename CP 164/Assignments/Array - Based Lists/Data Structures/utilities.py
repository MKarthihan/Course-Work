...
def list_test(source):
    ...
    print(f"Empty: {source.is_empty()}")
    print(f"Key: {key}")
    print(f"Key in List: {key in source}")
    print("-"*30)
    for x in source:
        print(x)
    print("")
    ...
    print(f"Key: {key}")
    print(f"Key in list: {key in source}")
    print(f"Key count {source.count(key)} times")
    print(f"Find value: {source.find(key)}")
    print("")
    ...
    print(f"Count: {var}")
    var2 = source.index(key)
    print(f"Index of {key}: {var2} ")
    return