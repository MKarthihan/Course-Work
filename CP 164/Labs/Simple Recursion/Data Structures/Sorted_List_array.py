...
class Sorted_List:
    ...
    def clean(self):
        ...
        while i > 0:
            for x in range(0, i):
                if self._values[i] == self._values[x]:
                    self._values.pop(i)
                    break
            i -= 1
        return
    ...
    def intersection(self, source1, source2):
        ...
        assert len(self._values) == 0, "Target list must be empty"
        self._values = []
        for x in source1._values:
            if x not in self._values and x in source2._values:
    ...
    def remove_many(self, key):
        ...
        ---------------------------------------------------------
        """
        ind = self._binary_search(key)
        while ind != -1:
            self._values.pop(ind)
    ...
    def split_alt(self):
        ...
        for i in range(len(self._values)):
            ...
            else: target2._values.append(self._values[i])
        self._values = []
        return target1, target2
    ...
    def split_key(self, key):
        ...
        for x in self._values:
            if x < key:
                target1._values.append(x)
            else:
                target2._values.append(x)
        return target1, target2
    ...
    def union(self, source1, source2):
        ...
        for x in source1._values:
            if x not in self._values:
                self._values.append(deepcopy(x))
